...
namespace Saraff.VisualFoxpro {
    ...
    public abstract class VfpExternalForm<T>:_VfpExternalComponent {

        protected VfpExternalForm() {
        }

        public virtual bool Invoke(out T result, params object[] args) {
            return this.IsSuccess(this.InvokeFormCore(this.FormName, args),out result);
        }
        ...
        protected abstract bool IsSuccess(object value,out T result);
    }
}
