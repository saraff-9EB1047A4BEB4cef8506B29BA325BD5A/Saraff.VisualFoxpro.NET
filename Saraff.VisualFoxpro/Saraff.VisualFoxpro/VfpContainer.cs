...
namespace Saraff.VisualFoxpro {
    ...
    internal sealed class VfpContainer:Container, IProxy {
        private EventHandler _handler;

        public VfpContainer(EventHandler handler) {
        ...
        protected override object GetService(Type service) {
            ...
            if(service==typeof(IProxy)) {
                return this;
            }
            if(service==typeof(VfpApplicationControl)&&(this._handler.Target is VfpApplicationControl)) {
