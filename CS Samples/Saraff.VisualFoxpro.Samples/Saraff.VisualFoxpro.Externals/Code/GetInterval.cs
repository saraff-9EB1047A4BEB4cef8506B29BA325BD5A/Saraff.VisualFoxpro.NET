...
namespace Saraff.VisualFoxpro.Externals.Code {

    public class GetInterval:VfpExternalProgram {

        public void Invoke(DateTime ndate, DateTime edate, int activePage, bool p1, bool p2, bool p3, bool p4) {
            this.Invoke(new object[] { ndate, edate, activePage, p1, p2, p3, p4 });
        }
