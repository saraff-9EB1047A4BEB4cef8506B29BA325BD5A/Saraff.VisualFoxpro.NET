...
namespace Saraff.VisualFoxpro.Externals.Classes {

    public sealed class bcFrmSpisok:VfpExternalObject {

        public void SetPeriod(DateTime ndate, DateTime edate) {
            this.InvokeMethod("SetPeriod", ndate, edate);
        }

        public void Show() {
            this.InvokeMethod("Show");
        }

        public void SetCheckChildNodes(bool isCheck) {
            this.InvokeMethod("SetCheckChildNodes", isCheck);
        }

        public string itog_str {
            get {
                return this.GetPropertyValue("itog_str") as string;
            }
        }
